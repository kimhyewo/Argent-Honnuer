...
public class LoginController {
	...
	public String loginPage(User user, HttpSession session, RedirectAttributes redirectAttributes) {					
		if(service.loginPage(user)) {										
			...
			redirectAttributes.addFlashAttribute("errorMessage", "로그인 또는 비밀번호가 일치하지 않습니다.");
