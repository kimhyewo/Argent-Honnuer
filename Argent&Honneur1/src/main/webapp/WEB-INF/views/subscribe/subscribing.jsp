...
<link rel="stylesheet" href="/resources/css/subscribe/subscribing/subscribing.css">
...
<body>
            ...
            <form  id="paymentForm">
                    ...
                    <div>
                        <table>
                            ...
                            <tr>
                                <th>구독기간</th>
                                <td>2023.06.01 ~ 2023.06.31</td>
                            </tr>
                            <tr>
                                <th>결제금액</th>
                                <td>
                                    <span>35,000원</span>(월 정기결제)                            </td>
                            </tr>
                        </table>
                    </div>
                    <div>
                ...
                <input type="text" id="cardNumber" name="cardNumber" style="width: 80%;" pattern="[0-9]*" required> 
                <label for="expiryDate">유효 기간</label> 
                <input type="text" id="expiryDate" name="expiryDate" style="width: 80%;" required>  
                <label for="cvv">CVV</label> 
                <input type="text" id="cvv" name="cvv" style="width: 90%;" required>
			...
			<div class="container">
				...
				<div class="subscription">
					...
					<div class="plan">
						...
						<div class="cta">
							<a href="#"><button type="button">선택</button></a>
						</div>
					</div>
	...
	<script src="/resources/js/subscribe/subscribe.js"></script>
	<script>
