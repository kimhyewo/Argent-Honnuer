                    ...
                    <div>
                        <div class="margin">
                            ...
                            <div>
                                ...
                                <input type="password" id="i2" class="mg-t" id="password-input" name="userpwd" placeholder="  ********" required>
                            </div>
                            <div>
                                <label for="i3">Confirm Password</label>
                                <i class="bi bi-eye spb2"></i>
                                <input type="password" id="i3" class="mg-t" id="confirm-password-input" name="passwdCheck" placeholder="  ********" required>
                            </div>
                            <div>
